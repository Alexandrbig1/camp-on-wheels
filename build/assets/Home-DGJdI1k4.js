...
`;function Bm(){return O.jsxs(O.Fragment,{children:[O.jsx(Wa,{children:O.jsxs(Ha,{children:[O.jsx("title",{children:"Camp On Wheels - Home Page"}),O.jsx("meta",{name:"description",content:"Unlock boundless journeys with Cruise Wheels. Rent a car in style, comfort, and confidence. Explore extraordinary adventures with our premium car rental services."}),O.jsx("meta",{name:"keywords",content:"car rental, adventure travel, stylish cars, comfortable journeys, Cruise Wheels, premium rental services"})]})}),O.jsxs(Mm,{children:[O.jsx(Em,{children:O.jsx(lh.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:3},children:O.jsxs(Am,{children:[O.jsxs(jm,{children:["Discover the Freedom of Mobile Exploration with"," ",O.jsx(Rm,{children:"Camp On Wheels"})]}),O.jsx(Lm,{children:"Embark on unforgettable journeys with CampOnWheels, where every road leads to new adventures. With our fleet of comfortable and fully-equipped camping cars, you can roam wherever your wanderlust takes you, and unwind amidst nature's embrace. Start your journey today and experience the thrill of the open road, without sacrificing the comforts of home."}),O.jsx("div",{style:{textAlign:"end"},children:O.jsx(Dm,{to:"catalog",children:"View our Catalog"})})]})})}),O.jsx(bh,{}),O.jsx(km,{})]})]})}export{Bm as default};
